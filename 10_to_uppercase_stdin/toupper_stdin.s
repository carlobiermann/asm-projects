...
#
# NOTE:		As decribed in Chapter 5: Review PGU by J.Bartlett 
#		this program DOES NOT push the file descriptors on 
#		to the stack but instead uses the .bss section. 
#
#		The program also uses the STDIN and STDOUT files 
#		to convert user input from the command line into 
#		uppercase output on the command line.
#
